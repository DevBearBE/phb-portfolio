...
export default function AboutPage() {
  return (
    <>
      <BreadCrumb />
      <Heading size="xl">Onze praktijk</Heading>
      <section>
        <Heading size="sm">Waar staan we voor?</Heading>
        <p>De visie van onze praktijk is...</p>
      </section>
      <section>
        <Heading size="sm">Waarvoor kan je bij ons terecht?</Heading>
        <p>
          Binnen onze praktijk bieden we zowel psychodiagnostisch onderzoek aan.
      ...
      <section>
        <Heading size="sm">Waar kan je ons vinden?</Heading>
        <p>
      ...
      <section className="flex flex-col md:flex-row gap-4 items-center justify-center lg:justify-end">
